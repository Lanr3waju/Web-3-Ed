  ...
  return (
    <main className="font-poppins">
      ...
      <section className="pt-32 px-6 text-center bg-gradient-to-b from-green-50 to-blue-50 pb-60">
        <p className="text-xl font-barlow font-bold text-green-600 tracking-wider">course details</p>
        ...
        <section className="text-justify py-4 bg-gradient-to-b pt-10 from-teal-50 through-teal-100 to-transparent flex flex-col justify-center w-full">
          ...
          <p className=" my-4 leading-loose">Each week will have interactive coding challenges, videos, and tutorials.
          </p>
          <h4 className="font-bold text-green-500 my-4">{decode("SKILLS YOU'LL LEARN")}</h4>
          <ul>
            <li className="bg-white p-4 rounded-3xl text-center shadow-md shadow-lime-700 my-3 tracking-wider ">BECOME A PROGRAMMER</li>
            <li className="bg-white p-4 rounded-3xl text-center shadow-md shadow-lime-700 my-3 tracking-wider">FULLSTACK DEVELOPMENT</li>
            <li className="bg-white p-4 rounded-3xl text-center shadow-md shadow-lime-700 my-3 tracking-wider">MASTER JAVASCRIPT</li>
          </ul>
          <ul className="my-8">
            ...
            <li className="tracking-widest mb-4">
              <span className="text-gray-500 font-semibold ">Time to complete:</span> 3 weeks
            </li>
            <li className="tracking-widest mb-4">
              <span className="text-gray-500 font-semibold ">Skill level:</span> Beginner
            </li>
            <li className="tracking-widest">
              <span className="text-gray-500 font-semibold ">Pre-requisites:</span> None
            </li>
          </ul>
          ...
          <section className="mt-24 bg-green-200 p-4 rounded-3xl shadow-lg text-left border-4 border-green-300 shadow-green-700">
            <h3 className="font-bold text-left text-green-900 my-4">CURRICULUM OVERVIEW</h3>
            <ul>
              <li className="my-8">
                <h4 className="font-bold text-lg">Week 1</h4>
                <p><span className="font-semibold">Basics:</span> functions, conditionals, loops, storage</p>
              </li>
              <li className="my-8">
                <h4 className="font-bold text-lg">Week 2</h4>
                <p><span className="font-semibold">Data structures:</span> arrays, maps, recursion</p>
              </li>
              <li className="my-8">
                <h4 className="font-bold text-lg">Week 3</h4>
                <p><span className="font-semibold">Networks:</span> local and asynchronous JS</p>
              </li>
            </ul>

            <button className="bg-black mx-auto shadow-md rounded-xl justify-center items-center font-semibold w-10/12 /6 h-16 shadow-green-900 text-white text-lg flex" type="button">Learn More</button>
          </section>
        ...
        <section className="text-justify py-4 flex flex-col justify-center w-full">
          <img src="" alt="" />
          <h3 className="text-2xl mt-4 font-bold my-4 text-left">Ethereum Developer Bootcamp</h3>
          <h4 className="font-bold text-green-500 my-4" >ABOUT THE COURSE</h4>
          <p className=" my-4 leading-loose">
            The Ethereum Developer Bootcamp is a comprehensive course that teaches you the fundamentals of web3 development.
            The course includes everything from typography to smart contracts to fully functional dApp development.
            This is the #1 resource to jumpstart your web3 career.
          </p>
          <p className=" my-2 leading-loose">Content is released on a weakly basis with live sessions, interactive coding challenges,
            videos, guides and weekly projects
          </p>
          <h4 className="font-bold text-green-500 my-4">{decode("SKILLS YOU'LL LEARN")}</h4>
          <ul>
            <li className="bg-white p-4 rounded-3xl text-center shadow-md shadow-lime-700 my-3 tracking-wider ">BECOME INTERVIEW READY</li>
            <li className="bg-white p-4 rounded-3xl text-center shadow-md shadow-lime-700 my-3 tracking-wider">MASTER SOLIDITY</li>
            <li className="bg-white p-4 rounded-3xl text-center shadow-md shadow-lime-700 my-3 tracking-wider">BUILD SMART CONTRACTS</li>
          </ul>
          <ul className="my-8">
            <li className="tracking-widest mb-4">
              <span className="text-gray-500 font-semibold ">Price:</span> Free
            ...
            <li className="tracking-widest mb-4">
              <span className="text-gray-500 font-semibold ">Time to complete:</span> 7 weeks
            </li>
            <li className="tracking-widest mb-4">
              <span className="text-gray-500 font-semibold ">Skill level:</span> Intermediate
            </li>
            <li className="tracking-widest">
              <span className="text-gray-500 font-semibold ">Pre-requisites:</span> JS Fundamentals
            </li>
          </ul>
          <p className=" my-4 leading-loose">
            This course gets you running with coding in one of the most popular
        ...
        <section className="text-justify py-4 flex flex-col justify-center w-full">
          ...
          <h4 className="font-bold text-green-500 my-4" >ABOUT THE COURSE</h4>
          <p className=" my-4 leading-loose">
            In this self-paced, 10 project course, {decode("you'll")} learn from industry experts on the cutting edge of web3,
            meet fellow developers, supercharge your skills through real-world applications, and mint Proof-of-Knowledge NFTs.
          </p>
          <p className=" my-2 leading-loose">Projects increase in difficulty and include video and written tutorials for the most relevant web3 use-cases, and rewarded you with coveted NFTs.
          </p>
          <h4 className="font-bold text-green-500 my-4">{decode("SKILLS YOU'LL LEARN")}</h4>
          <ul>
            <li className="bg-white p-4 rounded-3xl text-center shadow-md shadow-lime-700 my-3 tracking-wider ">DEVELOP A DEVELOPER PORTFOLIO</li>
            <li className="bg-white p-4 rounded-3xl text-center shadow-md shadow-lime-700 my-3 tracking-wider">BUILD SMART CONTRACTS</li>
            <li className="bg-white p-4 rounded-3xl text-center shadow-md shadow-lime-700 my-3 tracking-wider">FULL STACK WEB3 APPLICATIONS</li>
          </ul>
          <ul className="my-8">
            <li className="tracking-widest mb-4">
              <span className="text-gray-500 font-semibold ">Price:</span> Free
            ...
            <li className="tracking-widest mb-4">
              <span className="text-gray-500 font-semibold ">Time to complete:</span> 10 weeks
            </li>
            <li className="tracking-widest mb-4">
              <span className="text-gray-500 font-semibold ">Skill level:</span> Intermediate
            </li>
